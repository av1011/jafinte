        ...
        <Container>
          <Row className="justify-content-center">
            <Col lg="3" md="4">
              ...
              Jafinte is an advanced accounting and billing software for businesses. You can manage your invoices, quotes, inventory from one place.
                  </p>
              <ul className="social-icons py-7 list-unstyled mb-7 mb-lg-0">
              
                <li className="mr-2">
                  <Link href="//facebook.com/Jafintein-105493211844070">
                ...
                <li className="mr-2">
                  <Link href="//instagram.com/Jafintein/">
                    <a className={iconClassName}>
                    ...
                    <ul className="footer-list list-unstyled gr-text-9">
                      ...
                      <li className="py-2">
                        <Link href="/refund-policy">
                          <a className={linkClassName}>Refund Policy</a>
                        </Link>
                      </li>
                    </ul>
                  </div>
          ...
          <center>
      <h6>Made with ☕ for Better Accounting</h6>
      </center>  
        </Container>
