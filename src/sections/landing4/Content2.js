          ...
          <Row className="justify-content-center">
            <Col md="10" lg="8" xl="7">
              <div className="section-title text-center mb-11 mb-lg-19">
                <h2 className="gr-text-4 mb-6">Why Jafinte?</h2>
                <p className="gr-text-8 px-lg-4">
                Jafinte provide the benefits of a full billing and accounting solution to small and medium businesses. Help you create invoices, quotation, manages inventory and many more. 
                </p>
              </div>
            </Col>
          </Row>
