              ...
              <div className="feature-widget-1">
                <div className="media flex-column pr-8 pr-lg-7 pr-xl-12">
                  ...
                  <div className="media-body mt-10">
                    ...
                    Jafinte proivde dedicated support teams to give a customer awesome support.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="feature-widget-1">
                <div className="media flex-column pr-8 pr-lg-7 pr-xl-12">
                  ...
                  <div className="media-body mt-10">
                    ...
                    <p className="gr-text-9">
                   Jafinte provide with no hidden pricing. Without any extra cost you are getting all these under one roof.
                    </p>
                  </div>
                </div>
              </div>
