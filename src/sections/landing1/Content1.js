        ...
        <Row>
          <Col xl="6" lg="7" md="8">
            <div className="section-title mb-13">
              ...
              We know how everything works and why your business need Jafinte
              </h2>
            </div>
          </Col>
        </Row>
            ...
            <Row className="justify-content-between align-items-center pl-lg-13">
              ...
              <Col xl="10">
                <div className="about-content mt-12 mt-lg-23">
                  ...
                  Jafinte is the perfect billing and accounting solution. It helps you create invoices, and quotations, manage inventory, and much more - making your work life much easier and freeing up time to focus on other important aspects of running your business.
                  </p>
                </div>
              </Col>
            </Row>
