            ...
            <Col lg="4" md="10">
              <div className="content-text text-center text-lg-left mb-9 mb-lg-0 pr-xl-11">
                <h2 className="title gr-text-5 mb-8">
                 Become Jafinte Distributor.
                </h2>
                
                <p className="gr-text-8 mb-9">
                  Be the part of best billing and accounting software company.
                </p>
                <p className="gr-text-8 mb-9">
                  Jafinte is commited to help its distributors to earn more than ever.
                </p>
            ...
            <Col lg="4" md="6">
              <div className="stats-wrapper mt-6 mt-md-0 pl-xl-9">
                ...
                >
                  ...
                  <p className="gr-text-8 mb-0">
                 Jafinte support is always here to help you in any situations.
                  </p>
                </div>
              </div>
            </Col>
