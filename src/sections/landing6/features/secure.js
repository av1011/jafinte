...
import imgHero from "../../../assets/image/l4/png/secure.png";
        ...
        <Container>
          <Row className="align-items-center justify-content-center">
            ...
            <Col sm="10" lg="5">
             ...
             Secure <br className="d-none d-lg-block" />
                  
                </h2>
                <p className="gr-text-8 mb-0 text-color-opacity">
                Jafinte is a fast, efficient, and secure cloud platform that is made with a mission to provide the best billing software.   </p>
