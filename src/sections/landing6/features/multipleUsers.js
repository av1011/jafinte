...
import imgHero from "../../../assets/image/l4/png/users.png";
          ...
          <Row className="align-items-center justify-content-center">
            ...
            <Col sm="10" lg="5" className="order-lg-1">
              <div className="content-text">
                ...
                Jafinte provide the best multi-user system to enable the sharing of the system with your employees or accountant easily without sharing a password.   </p>
