...
import imgHero from "../../../assets/image/l4/png/book.png";
          ...
          <Row className="align-items-center justify-content-center">
            ...
            <Col sm="10" lg="5" className="order-lg-1">
              <div className="content-text">
                ...
                Jafinte helps business owner to keep their book easy. Business owners don't need to waste time on calculating profit, loss, per customer, and many more.   </p>
