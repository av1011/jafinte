  ...
  return (
    ...
    <meta property="og:title" content="Free Billing and Accounting Software | Jafinte" key="title" />
      ...
      >
              ...
              <Col lg="9" xl="8">
                <div className="px-md-15 text-center mb-5 mb-lg-13">
                  ...
                  <p className="gr-text-8 mb-0">
                    Jafinte comes with affordable pricing
                  </p>
                </div>
              </Col>
            </Row>
        ...
        <Link href="/pricing">
          <a>   <h4 style={{ marginLeft: '28rem' }} path="/pricing">Check out - INR Pricing</h4></a>
        </Link>
                    ...
                    <div className="price-content">
                      ...
                      <ul className="card-list list-style-check pl-0 mt-7 mt-lg-11">
                        ...
                        <li className="gr-text-9">
                          <i className="icon icon-check-simple"></i> 50 Clients
                        </li>
                        ...
                        <li className="disabled gr-text-9">
                          <i className="icon icon-simple-remove"></i>   Dedicated Account Manager
                        </li>
                        <li className="disabled gr-text-9">
                          <i className="icon icon-simple-remove"></i>   Premium Support
                        </li>
                      </ul>
                    </div>
