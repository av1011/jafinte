...
const TermsConditions = () => {
  return (
    <>
      <Head>
    <title>Refund & Cancellation Policy | Free Billing and Accounting Software | Jafinte</title>
...
<p style={{width: "80%", marginLeft: '6rem'}}>Jafinte believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
...
<p style={{width: "80%", marginLeft: '6rem'}}>No cancellations are entertained for those products/services that the Jafinte marketing team has obtained on special discounts. These are limited occasion offers and therefore cancellations are not possible.
