...
const Features = () => {
  ...
  return (
    <>
      <Head>
    <title>Features | Free Billing and Accounting Software | Jafinte</title>
            ...
            <Row className="justify-content-center">
              <Col xl="8" lg="9">
                <div className="px-md-12 text-center mb-11 mb-lg-19">
                  ...
                  Revamp your billing process with Jafinte - the game-changing accounting and billing software designed for accountants who demand the best. Take the first step towards effortless financial management - give Jafinte a try today!   </p>
                </div>
              </Col>
            </Row>
              ...
              <Col lg="4" md="6" sm="6" xs="8" className=" mb-lg-18 mb-9">
                <div className="feature-card d-flex flex-column flex-md-row ">
                  ...
                  <div className="card-texts">
                    ...
                    Jafinte is the most cutting-edge Invoices generation platform. It allows you to create professional invoices that are 100% compliant with the accounting standards and GST standards. Generate your invoices in 5 minutes and get paid instantly – no more waiting for days!
                    </p>
                  </div>
                </div>
              </Col>
              <Col lg="4" md="6" sm="6" xs="8" className="mb-lg-18 mb-9">
                <div className="feature-card d-flex flex-column flex-md-row ">
                  ...
                  <div className="card-texts">
                    ...
                    <p className="gr-text-9 mb-0">
                    Jafinte is a small business accounting system, designed to help you manage your entire business with ease. Our goal is to make accounting and billing simple for everyone.
                    </p>
                  </div>
                </div>
              </Col>
              <Col lg="4" md="6" sm="6" xs="8" className="mb-lg-18 mb-9">
                <div className="feature-card d-flex flex-column flex-md-row ">
                  ...
                  <div className="card-texts">
                    ...
                    <p className="gr-text-9 mb-0">
                    Jafinte, the most advanced billing platform in the world. It makes invoicing and receiving payments effortlessly. We are not just a tool for generating estimates that are sent to clients via email but a complete solution that helps you manage your business more efficiently.
                    </p>
                  </div>
                </div>
              </Col>
              ...
              <Col lg="4" md="6" sm="6" xs="8" className="mb-lg-18 mb-9">
                <div className="feature-card d-flex flex-column flex-md-row ">
                  ...
                  <div className="card-texts">
                    ...
                    <p className="gr-text-9 mb-0">
                    Jafinte is a fast, efficient, and secure cloud platform that is made with a mission to provide the best billing software which is compatible with GST billing and many more.
