...
const Contact = () => {
  return (
    <>
     <Head>
    <title>Contact us | Free Billing and Accounting Software | Jafinte</title>
              ...
              <Col lg="9" xl="8">
                <div className="px-md-15 text-center">
                  ...
                  <p className="gr-text-8 mb-13">
                    Jafinte team is working round the clock to provide you the accounting and billing software
                  </p>
                </div>
              </Col>
            </Row>
